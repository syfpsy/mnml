...
## What this is
mnml — a **keyboard-first clipboard manager for Windows** (Electron + TS). Alt-Alt to summon; clipboard history (text/links/images, SQLite FTS5), Ctrl+1…9 quick-paste (strips formatting), saved snippets, Start-Menu + `ms-settings:` launcher. One 440×540 window, local SQLite, no accounts/telemetry. MIT.
